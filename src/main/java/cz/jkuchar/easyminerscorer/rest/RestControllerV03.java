...
@ResponseBody
@Api(value="API v0.3")
@RequestMapping({ "v0.3", "latest" })
public class RestControllerV03 {
	...
	public @ResponseBody ResponseEntity<Response> scorer(
			@ApiParam(value = "pmml file", required=true) @RequestBody String model,
	...
	public @ResponseBody ResponseEntity<Response> getScorer(
			...
			@ApiParam(value = "json file", required=true) @RequestBody String data) {
